...
var combos = {
    'angry': ['mean', 'annoyed', 'fight', 'animal', 'happy', 'upset', 'angry'],
    'fight': ['mean', 'fight', 'sad', 'happy', 'angry'],
    'ok': ['ok'],
    'desperate': ['annoyed', 'concerned', 'sad', 'desperate', 'alcohol', 'enamoured'],
    'concerned': ['scared', 'crazy', 'annoyed', 'shocked', 'concerned', 'confused', 'sad', 'desperate', 'banana'],
    'sad': ['mean', 'enamoured', 'annoyed', 'concerned', 'fight', 'sad', 'happy', 'desperate', 'alcohol', 'friends'],
    'alien': ['happy', 'alien'],
    'happy': ['enamoured', 'mean', 'nice', 'angry', 'alien', 'fight', 'angel', 'sad', 'happy', 'alcohol', 'friends'],
    'shocked': ['shocked', 'concerned'],
    'cool': ['cool', 'enamoured', 'chill', 'dance'],
    'chill': ['cool', 'chill'],
    'alcohol': ['dance', 'sad', 'happy', 'desperate', 'alcohol'],
    'friends': ['sad', 'friends', 'happy', 'nice'],
    'nice': ['friends', 'happy', 'nice', 'funny'],
    'enamoured': ['cool', 'sad', 'happy', 'desperate', 'enamoured'],
    'mean': ['mean', 'fight', 'sad', 'happy', 'banana', 'angry'],
    'upset': ['angry', 'upset'],
    'mischievous': ['mischievous'],
    'pensive': ['pensive'],
    'music': ['music'],
    'indifferent': ['indifferent'],
    'annoyed': ['annoyed', 'concerned', 'sad', 'desperate', 'angry'],
    'angel': ['happy', 'dance', 'angel'],
    'animal': ['angry', 'animal'],
    'banana': ['concerned', 'dance', 'mean', 'banana'],
    'dance': ['dance', 'angel', 'cool', 'banana', 'alcohol'],
    'confused': ['confused', 'concerned', 'crazy'],
    'crazy': ['confused', 'concerned', 'crazy'],
    'scared': ['scared', 'concerned'],
    'funny': ['nice', 'funny']
}
...
function form_change(){
    setTimeout(function(){
        ...
        if (selected_tags.length > 0){
            console.log(combos[selected_tags[0]]);
            for (var el of tag_flex_element.children){
                if (el.id == "clear_selection"){
                    continue;
                }
                ...
                var in_combo = true;
                for (theme of selected_tags){
                    in_combo = in_combo && combos[theme].includes(el.textContent);
                }
                el.firstChild.disabled = !in_combo;
                //console.log(el);
            }
        }
    }, 0);
